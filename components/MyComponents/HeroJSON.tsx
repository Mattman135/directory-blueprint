...
const Hero = () => {
  ...
  useEffect(() => {
    const rows = Array.isArray(dataFromJson) ? (dataFromJson as dataItem[]) : []
      ...
      <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start backgroundcolor">
          ...
          <div className="max-w-100">
            Hitta ekologiska butiker, gårdar eller liknande nära dig i hela
            Sverige genom att söka efter din stad. Få relevant information om
            varje hälsobutik så att du enkelt kan hitta en butik eller gård som
            passar dig. Sveriges enda webbkatalog för ekologiska gårdar - skapad
            för att göra det enkelt för dig att handla ekologisk mat.
          </div>
          <div className="relative w-full max-w-xs">
            <label className="input">
              ...
              <input
                type="search"
                required
                placeholder="Sök på stad eller adress"
                value={searchTerm}
