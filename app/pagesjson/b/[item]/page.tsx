...
export default async function ItemDetailPage({ params }: ItemDetailPageProps) {
  ...
  const items = Array.isArray(data) ? (data as HundrastgardarItem[]) : []
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-sm text-base-content/70 leading-relaxed">
                      Dubbelkolla öppettiderna nedan för {foundItem.title} så
                      att du kan planera ditt besök så att du och din hund
                      hinner njuta av anläggningen.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-base-content/70 leading-relaxed">
                      ...
                      göra ditt besök trevligare. Kontakta parken för
                      fullständig information om tillgängliga faciliteter.
                    </p>
                  </div>
                </div>
              </div>
